...
function Resume() {
  let resume = [
    ...
    {
      company: 'Flesh Restaurant',
      title: 'Founder, Chef de Cuisine',
      logo: logoStarbucks,
      start: '2014',
      end: '2019',
    },
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button
        href="https://storage.googleapis.com/kniferoll_bucket-portfolio/Resume%20-%20Simon%20Lewis.pdf"
        variant="secondary"
        className="group mt-6 w-full"
      >
        {/* #Button to download <button type="button" class="btn btn-secondary" data-bs-toggle="popover" title="Popup title" data-bs-content="Popup content">Trigger</button> */}
        Download CV
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            ...
            /> */}
            <SocialLink
              href="https://github.com/simonlewi5"
